			...
			<div class="box">
			    ...
			    <div class="box-body">
			    	<div id="table_wrapper" class="dataTables_wrapper form-inline dt-boostrap">
			    		...
			    		<div class="row">
			    			<div class="col-sm-12">
			    				<table id="table_quizs" class="table table-bordered table-striped dataTable" role = "grid" aria-describedby = "example1_info">
			    					<thead>
			    						<tr role="row">
...
<script src="/media/admin/js/quizs.js"></script>
