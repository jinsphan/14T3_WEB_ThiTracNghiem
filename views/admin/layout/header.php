        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $_SESSION["loginUser"]["fullname"]; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  <?php echo $this->$_SESSION["loginUser"]["fullname"]; ?> - Web Developer
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p class="name-admin"><?php echo $_SESSION["loginUser"]["fullname"]; ?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo vendor_app_util::url(array('ctl'=>'subject')); ?>">
            <i class="fa fa-th"></i> <span>Subject</span>
            <!-- <span class="pull-right-container">
        ...
        <li>
          <a href="<?php echo vendor_app_util::url(array('ctl'=>'quiz')); ?>">
            <i class="fa fa-pie-chart"></i> <span>Quiz</span>
            <!-- <span class="pull-right-container">
              <small class="label pull-right bg-green">new</small>
            </span> -->
          </a>
